    ...
    */
    ...
    renderTopControls() {
        return(
            <Animated.View style={[
                ...
                <Image
                    source={require('src/Images/video/top-vignette.png' ) }
    ...
    renderBack() {
        return this.renderControl(
            <Image
                source={ require( 'src/Images/video/back.png' ) }
    ...
    renderVolume() {
        return (
            <View style={ styles.volume.container }>
                ...
                >
                    <Image style={ styles.volume.icon } source={ require( 'src/Images/video/volume.png' ) } />
                </View>
            </View>
        );
    }
     ...
     */
    renderFullscreen() {
        let source = this.state.isFullscreen === true ? require( 'src/Images/video/shrink.png' ) : require( 'src/Images/video/expand.png' );
        return this.renderControl(
            <Image source={ source } />,
            this.methods.toggleFullscreen,
    ...
    renderBottomControls() {
        return(
            ...
            <Image
                source={ require( 'src/Images/video/bottom-vignette.png' ) }
                style={[ styles.controls.column, styles.controls.vignette,
            ]}>
                <View style={[
     ...
     */
    renderPlayPause() {
        let source = this.state.paused === true ? require( 'src/Images/video/play.png' ) : require( 'src/Images/video/pause.png' );
        return this.renderControl(
            <Image source={ source } />,
        ...
        if ( this.state.loading ) {
            return (
                <View style={ styles.loader.container }>
                    <Animated.Image source={ require( 'src/Images/video/loader-icon.png' ) } style={[
                        styles.loader.icon,
                        { transform: [
        ...
        if ( this.state.error ) {
            return (
                <View style={ styles.error.container }>
                    <Image source={ require( 'src/Images/video/error-icon.png' ) } style={ styles.error.icon } />
